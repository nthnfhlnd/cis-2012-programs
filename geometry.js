...
function circleArea()
{
    ...
    var floatCircleArea = parseFloat (floatRadius * floatRadius * Math.PI);
...
function rectPerim()
{
    ...
    var floatRectPerim = 2 * (floatRectWidth + floatRectHeight);
...
{
    var flatRectWidth = parseFloat($("rect_width").value);
	var flatRectHeight = parseFloat($("rect_height").value);
    
    alert ("The Rectangle Area is " + rectArea(flatRectWidth, flatRectHeight));
}
...
//    $("radius").value = "";
    ...
    $("calc_circle_area").onclick = calcCircleArea; // runs the calcCircleArea when clicked
    $("calc_tri_area").onclick = calcTriArea; // runs the calcTriArea when clicked
    $("calc_tri_perim").onclick = calcTriPerim; // runs the calcTriPerimeter when clicked
    $("calc_rect_perim").onclick = calcRectPerim; // runs the calcRectPerim when clicked
    $("calc_rect_area").onclick = calcRectArea; // runs the calcRectArea when clicked

...
var generate = function () 
{
    ...
    //blanks invalid user inputs
        ...
        while (intCount > 2)
        {
            ...
            i = j;
            j = k;
            //the above code sets up the variables i, j, and k so that they calculate the Fibonacci numbers
            stringOutput = stringOutput + " " + k;
            intCount--;
        }
        //the above loop uses the given info to generate the appropriate number of Fibonacci numbers
        
        $("output").value = stringOutput; //posts the Fibonacci numbers to the html DOM
